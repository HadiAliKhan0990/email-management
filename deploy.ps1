...
$SERVER = "ubuntu@ec2-15-223-192-87.ca-central-1.compute.amazonaws.com"
...
if ($isRunning -eq "yes" -and $mode -eq "quick") {
    ...
    Write-Host "Service URL: http://ec2-15-223-192-87.ca-central-1.compute.amazonaws.com:3006" -ForegroundColor Cyan
    exit 0
}
