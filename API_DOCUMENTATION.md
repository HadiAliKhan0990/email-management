...
## Base URL
```
http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api
```
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/test
```
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails \
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails/import/csv \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails/import/excel \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails/import/townticks \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "groupId": 1
...
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Get emails with filters and pagination
curl -X GET "http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails?page=1&limit=50&status=ACTIVE" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X PUT http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails/1/status \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "status": "UNSUBSCRIBED"
...
**cURL Example:**
```bash
curl -X DELETE http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/emails/stats/overview \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Newsletter Subscribers",
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X PUT http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
**cURL Example:**
```bash
curl -X DELETE http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups/1/emails/5 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X DELETE http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups/1/emails/5 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/email-groups/stats/overview \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
# Get all campaigns
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Get campaigns filtered by status
curl -X GET "http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns?status=SENT" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X PUT http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
**cURL Example:**
```bash
curl -X POST http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns/1/send \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X DELETE http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns/1 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
**cURL Example:**
```bash
curl -X GET http://ec2-3-96-191-90.ca-central-1.compute.amazonaws.com:3006/api/campaigns/1/analytics \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
5. **Verify environment variable**: SSH into the server and check if AUTH_KEY is in the `.env` file:
   ```bash
   ssh -i "E:\aws-services-stage.pem" ubuntu@ec2-3-96-191-90.ca-central-1.compute.amazonaws.com
